...
A dashboard comprises a set of cards arranged on a grid. These cards are questions - such as [tables, charts, or maps](/docs/users-guide/05-visualizing-results.md) - or they can be [text boxes](https://www.metabase.com/learn/dashboards/markdown).
...
**2. From the question that you wish to add:** 
